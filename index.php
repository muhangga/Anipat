        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_team">
                    <div class="thumb">
                        <img src="assets/img/shop/user_pic.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_team">
                    <div class="thumb">
                        <img src="assets/img/shop/user_pic.png">
                    </div>
                    <div class="member_name text-center">
                        <div class="mamber_inner">
                            <h4>Rafi Adira Faiz</h4>
                            <p>Senior Director</p>
                        </div>
                    </div>
                </div>
